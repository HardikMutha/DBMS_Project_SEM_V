  ...
  const getFilteredCampgrounds = () => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(cg =>
        ...
        cg.type?.toLowerCase().includes(searchTerm.toLowerCase())
      );
    }
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">Campground Management</h1>
                <p className="text-gray-500 text-sm mt-1">Manage listings and approval requests</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900 mt-2">
                  {campgrounds.filter(cg => !cg.isApproved).length}
                </p>
              </div>
            ...
            {filteredCampgrounds.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredCampgrounds.map((campground) => (
                  <div key={campground.campgroundId} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
